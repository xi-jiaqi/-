...
class mydb(object):
    def __init__(self):
        self.conn = pymysql.connect(host="127.0.0.1", port=3306, user="root", passwd="314159pi", db="test", charset="utf8", autocommit=True)
...
dbpool = dbHelper(host="127.0.0.1", port=3306, user="root", passwd="314159pi", db="test", charset="utf8")
